...
type Cache interface {
	GetOrUpdate(ctx context.Context, key []byte, update func(ctx context.Context) ([]byte, error)) ([]byte, error)
}
...
func (cache *localCache) GetOrUpdate(ctx context.Context, key []byte, update func(ctx context.Context) ([]byte, error)) ([]byte, error) {
	strkey := string(key)
...
func (cache *globalCache) GetOrUpdate(ctx context.Context, key []byte, update func(ctx context.Context) ([]byte, error)) ([]byte, error) {
	now := time.Now()
